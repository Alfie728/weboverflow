...
const QuestionCard = ({
  ...
  return (
    <>
      <div className="card-wrapper rounded-[10px] border p-9 shadow-lg transition-transform hover:scale-105 hover:bg-light-800 hover:shadow-xl dark:shadow-light-100 dark:hover:bg-dark-400 dark:hover:shadow-light-200 sm:px-11">
